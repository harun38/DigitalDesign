...
HD_PWD='C:/Users/harun/Digital_Project/Digital_Project.runs/Project_design_xup_dff_en_reset_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_design_xup_dff_en_reset_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_design_xup_dff_en_reset_0_5.tcl
