...
HD_PWD='C:/Users/harun/Digital_Project/Digital_Project.runs/Project_design_E_input_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_design_E_input_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_design_E_input_0_0.tcl
