...
HD_PWD='C:/Users/harun/Digital_Project/Digital_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project_design_wrapper.tcl -notrace
