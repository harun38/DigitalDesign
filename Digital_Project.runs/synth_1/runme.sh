...
HD_PWD='C:/Users/harun/Digital_Project/Digital_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_design_wrapper.tcl
