...
architecture STRUCTURE of F_input is
  component F_input_xup_and4_0_2 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    c : in STD_LOGIC;
  ...
  end component F_input_xup_and4_0_2;
  ...
  component F_input_xup_inv_0_3 is
  port (
    a : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component F_input_xup_inv_0_3;
  ...
  component F_input_xup_and3_0_1 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    c : in STD_LOGIC;
  ...
  end component F_input_xup_and3_0_1;
  component F_input_xup_and2_0_1 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component F_input_xup_and2_0_1;
  component F_input_xup_inv_0_4 is
  port (
    a : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component F_input_xup_inv_0_4;
...
begin
  ...
  NC_1 <= NC;
  Reset_1 <= Reset;
xup_and2_0: component F_input_xup_and2_0_1
     port map (
      a => xup_inv_2_y,
      b => xup_or2_0_y,
      y => xup_and2_0_y
    );
xup_and3_0: component F_input_xup_and3_0_1
     port map (
      a => F_1,
      b => xup_inv_1_y,
      c => xup_inv_0_y,
...
xup_and4_0: component F_input_xup_and4_0_2
     port map (
      a => E_1,
      b => L1_1,
      c => xup_inv_0_y,
...
xup_inv_0: component F_input_xup_inv_0_3
     port map (
      a => L2_1,
      y => xup_inv_0_y
    );
...
xup_inv_2: component F_input_xup_inv_0_4
     port map (
      a => Reset_1,
      y => xup_inv_2_y
    );
