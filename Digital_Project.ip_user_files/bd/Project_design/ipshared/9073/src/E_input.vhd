...
architecture STRUCTURE of E_input is
  component E_input_xup_and4_0_3 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    c : in STD_LOGIC;
  ...
  end component E_input_xup_and4_0_3;
  component E_input_xup_or3_0_2 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    c : in STD_LOGIC;
  ...
  end component E_input_xup_or3_0_2;
  ...
  component E_input_xup_inv_1_1 is
  port (
    a : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component E_input_xup_inv_1_1;
  component E_input_xup_inv_2_1 is
  port (
    a : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component E_input_xup_inv_2_1;
  ...
  component E_input_xup_and4_1_1 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    c : in STD_LOGIC;
  ...
  end component E_input_xup_and4_1_1;
  ...
  component E_input_xup_inv_1_2 is
  port (
    a : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component E_input_xup_inv_1_2;
...
xup_and4_0: component E_input_xup_and4_0_3
     port map (
      a => C_1,
      b => L1_1,
      c => xup_inv_2_y,
...
xup_and4_1: component E_input_xup_and4_1_1
     port map (
      a => NC_1,
      b => xup_inv_2_y,
      c => xup_inv_0_y,
...
xup_inv_1: component E_input_xup_inv_1_1
     port map (
      a => NC_1,
      y => xup_inv_1_y
    );
xup_inv_2: component E_input_xup_inv_2_1
     port map (
      a => L2_1,
      y => xup_inv_2_y
    );
xup_inv_3: component E_input_xup_inv_1_2
     port map (
      a => Reset_1,
      y => xup_inv_3_y
    );
...
xup_or3_0: component E_input_xup_or3_0_2
     port map (
      a => xup_and4_0_y,
      b => xup_and2_1_y,
      c => xup_and4_1_y,
