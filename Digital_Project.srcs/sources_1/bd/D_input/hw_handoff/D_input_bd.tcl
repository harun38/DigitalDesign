...
################################################################
# This is a generated script based on design: D_input
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net C_1 [get_bd_ports C] [get_bd_pins xup_and4_0/a]
  connect_bd_net -net D_1 [get_bd_ports D] [get_bd_pins xup_and3_0/a] [get_bd_pins xup_and4_1/a] [get_bd_pins xup_and4_2/a]
  connect_bd_net -net L1_1 [get_bd_ports L1] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net L2_1 [get_bd_ports L2] [get_bd_pins xup_inv_1/a] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net NC_1 [get_bd_ports NC] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_and4_0/b] [get_bd_pins xup_and4_1/b] [get_bd_pins xup_inv_3/a]
  connect_bd_net -net Reset_1 [get_bd_ports Reset] [get_bd_pins xup_inv_2/a]
  connect_bd_net -net xup_and2_1_y [get_bd_ports D_out] [get_bd_pins xup_and2_1/y]
  connect_bd_net -net xup_and3_0_y [get_bd_pins xup_and3_0/y] [get_bd_pins xup_or3_0/a]
  connect_bd_net -net xup_and4_0_y [get_bd_pins xup_and4_0/y] [get_bd_pins xup_or2_1/b]
  connect_bd_net -net xup_and4_1_y [get_bd_pins xup_and4_1/y] [get_bd_pins xup_or3_0/b]
  connect_bd_net -net xup_and4_2_y [get_bd_pins xup_and4_2/y] [get_bd_pins xup_or3_0/c]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and4_0/d] [get_bd_pins xup_and4_1/c] [get_bd_pins xup_and4_2/c] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and4_0/c] [get_bd_pins xup_and4_1/d] [get_bd_pins xup_and4_2/b] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_1/b] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and4_2/d] [get_bd_pins xup_inv_3/y]
  connect_bd_net -net xup_or2_1_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_or2_1/y]
  connect_bd_net -net xup_or3_0_y [get_bd_pins xup_or2_1/a] [get_bd_pins xup_or3_0/y]
