...
################################################################
# This is a generated script based on design: F_input
#
...
proc create_root_design { parentCell } {
  ...
  set F_out [ create_bd_port -dir O F_out ]
  ...
  connect_bd_net -net F_1 [get_bd_ports F] [get_bd_pins xup_and3_0/a]
  connect_bd_net -net L1_1 [get_bd_ports L1] [get_bd_pins xup_and4_0/b]
  connect_bd_net -net L2_1 [get_bd_ports L2] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net NC_1 [get_bd_ports NC] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net Reset_1 [get_bd_ports Reset] [get_bd_pins xup_inv_2/a]
  connect_bd_net -net xup_and2_0_y [get_bd_ports F_out] [get_bd_pins xup_and2_0/y]
  ...
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and3_0/b] [get_bd_pins xup_and4_0/d] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_inv_2/y]
