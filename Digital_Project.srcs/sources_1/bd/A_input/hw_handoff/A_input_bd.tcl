...
################################################################
# This is a generated script based on design: A_input
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins xup_and2_1/a]
  ...
  connect_bd_net -net F_1 [get_bd_ports F] [get_bd_pins xup_and3_1/a]
  connect_bd_net -net IDLE_1 [get_bd_ports IDLE] [get_bd_pins xup_and2_0/a]
  connect_bd_net -net L1_1 [get_bd_ports L1] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_inv_1/a] [get_bd_pins xup_xnor2_0/b]
  connect_bd_net -net L2_1 [get_bd_ports L2] [get_bd_pins xup_and3_1/c] [get_bd_pins xup_and4_0/b]
  connect_bd_net -net NC_1 [get_bd_ports NC] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and3_1/b] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_xnor2_0/a]
  ...
  connect_bd_net -net xup_and2_2_y [get_bd_ports AOut] [get_bd_pins xup_and2_2/y]
  connect_bd_net -net xup_and3_0_y [get_bd_pins xup_and3_0/y] [get_bd_pins xup_or4_0/c]
  ...
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and3_0/c] [get_bd_pins xup_and4_0/d] [get_bd_pins xup_inv_0/y]
  ...
  connect_bd_net -net xup_or2_0_y [get_bd_pins xup_and2_2/a] [get_bd_pins xup_or2_0/y]
  connect_bd_net -net xup_or4_0_y [get_bd_pins xup_or2_0/a] [get_bd_pins xup_or4_0/y]
  connect_bd_net -net xup_xnor2_0_y [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xnor2_0/y]
