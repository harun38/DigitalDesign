...
################################################################
# This is a generated script based on design: B_input
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net E_1 [get_bd_ports E] [get_bd_pins xup_and4_1/a]
  connect_bd_net -net L1_1 [get_bd_ports L1] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_xnor2_0/b]
  connect_bd_net -net L2_1 [get_bd_ports L2] [get_bd_pins xup_and4_0/b] [get_bd_pins xup_and4_1/d]
  connect_bd_net -net NC_1 [get_bd_ports NC] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_and4_1/b] [get_bd_pins xup_inv_1/a] [get_bd_pins xup_xnor2_0/a]
  ...
  connect_bd_net -net xup_and2_1_y [get_bd_ports B_out] [get_bd_pins xup_and2_1/y]
  ...
  connect_bd_net -net xup_and4_1_y [get_bd_pins xup_and4_1/y] [get_bd_pins xup_or4_0/b]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and3_0/c] [get_bd_pins xup_and4_0/c] [get_bd_pins xup_and4_1/c] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and4_0/d] [get_bd_pins xup_inv_1/y]
  ...
  connect_bd_net -net xup_xnor2_0_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_xnor2_0/y]
